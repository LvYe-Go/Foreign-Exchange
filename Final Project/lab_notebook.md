...
...
So for each words showing on the files we have several vector that containing tf-idf for it.  Then, we can use k-means to get the topics of it.  For example, we ahve ten topics now . Then the advanced requirement: 
...
The project is based on this package and my modification. 
    ...
    * LDA used in this project in  big picture: 
...
#### Advantages of my training method  and visulazation
    ...
    1. LDA pays attention to the relationship among current topics  and other words, it is more reasonable over than TF-IDF in this point. 

    2. Considered about the empty words like "the, of , are ..." , filter out them, to make the result more accurate and meaningful.

    3. Considered about the charset decode type , "UTF-8" and tried others. 

    4. Filtered out other dirty words.  

    5. Using Gson and java to converting data to avoid twice I/O, enhance the efficiency. 
