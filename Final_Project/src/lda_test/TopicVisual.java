...
public class TopicVisual 
{
	...
	public static String folderpath = "data/train";  // Path to data
	...
	public static void main(String[] args) throws IOException
	{
	     ...
	     String[] preKnow = {
	    		 ...
	    		 "small", "frequ", "those", "mast", "energy", "antigen", "sceptrin", "iron"
	     };
	     
	     for(String str : preKnow){
	    	 System.out.println(str);
	     }
	     System.out.println("Please input word you choose\n based on prior knowledge please select from above words");
